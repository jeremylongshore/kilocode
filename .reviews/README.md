...
|--------|-------|
| PRs Reviewed | 22 / 75 |
| Test Runs Captured | 6 (with full evidence logs) |
...
Raw terminal output from fresh test runs (turbo cache cleared):

| Log File | PRs Covered | Tests Passed | Size |
|----------|-------------|-------------|------|
| [`combined-batch-1`](logs/) | #5370, #5660, #5704 | 7,859 | 972K |
| [`PR-5562`](logs/) | #5562 | 7,803 | 942K |
| [`combined-batch-2`](logs/) | #5739, #5817 | 7,938 | 946K |
| [`combined-batch-3`](logs/) | #5331, #5568 | 7,935 | 944K |
| [`combined-batch-4`](logs/) | #5667, #5728, #5807, #5865, #5869 | 7,935 | 946K |
| [`mega-combined-all`](logs/) | **11 PRs merged together** | **7,938** | 947K |
...
├── logs/                        # Master test evidence archive (6 runs, ~5.7MB)
